...
const Contact = () => {
  ...
  return (
    <div className='w-full grid grid-cols-1 place-items-center md:py-5 bg-basic'>
        <h1 className='py-2 text-center font-extrabold text-2xl text-secondary'>Have an enquiry?</h1>
        <form className='w-[80%] md:w-[50%]  flex flex-col md:ml-20 space-y-3 md:space-y-5' onSubmit={handleSubmit}>
