  ...
  return (
    <div className='bg-white'>
        ...
        <div className='flex justify-center bg-blue-300 rounded-3xl w-72 relative mt-36 md:mt-10 mx-auto space-x-2 py-2'>
          <button onClick={() => setToggle(true)} className='py-1 px-4 bg-blue-600  text-basic rounded-3xl'>Featured Cars</button>
          <button onClick={() => setToggle(false)} className='py-1 px-4   text-basic rounded-3xl'>Recent Listed</button>
        </div>
