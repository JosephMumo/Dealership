...
const Navmain = () => {
  return (
    <div className=' hidden text-black md:flex md:flex-row md:justify-center md:items-center md:space-x-5 lg:space-x-12 md:py-3 md:px-2 lg:px-5 md:bg-white md:w-full'>
        <Link to='/'>
            <h1 className='text-black md:text-2xl lg:text-3xl font-thin'>RidesAuto</h1>
        </Link>
        <Link to='/cars'>
        ...
        <div>
            <input type='text' name='search' id='search' placeholder='Find a Rides car' className='bg-neutral-50 py-1 px-2 md:24 lg:w-64 outline-none' />
        </div>
